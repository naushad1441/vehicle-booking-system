    	...
    	<div class="container-fluid">
            ...
            <form action="{{ route('admin.vehicles.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="daily_rate" name="daily_rate" min="0.01" step="0.01" value="{{ old('daily_rate') }}">
                </div>
        
                <div class="form-group">
                    <label for="hourly_rate">Hourly Rate (Optional)</label>
                    <input type="number" class="form-control" id="hourly_rate" name="hourly_rate" min="0.01" step="0.01" value="{{ old('hourly_rate') }}">
